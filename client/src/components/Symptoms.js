	...
	return (
		<div className="align-left flex-column">
			...
			<form onSubmit={(e) => e.preventDefault()} className="flex-column">
				<Checkbox
					onChange={() => setSymptoms({ ...symptoms, fever: !symptoms.fever })}
					className="label"
				>
					Fever
				</Checkbox>
				<Checkbox
					onChange={() => setSymptoms({ ...symptoms, cough: !symptoms.cough })}
					className="label"
				>
					Cough
				</Checkbox>
				...
				<Checkbox
					onChange={() => setSymptoms({ ...symptoms, vomit: !symptoms.vomit })}
					className="label"
				>
					Vomitting
				</Checkbox>
				...
				{result > 0 ? (
					<Card className="flex-column">
						...
						<Link to="/testing" style={{ display: 'block' }}>
							<Button className="testing-btn" icon={<EnvironmentOutlined />}>
