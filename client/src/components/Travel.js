...
const Travel = () => {
    ...
    return (
        <div>
            ...
            {(country==="US") && (locationsNotInGeoData.indexOf(location.countryCode) !== -1) ?
                <div><br />Travel Regulations for User's Preferred Country were not found, defaulted to United States.<br /></div> : <br />}
            <hr></hr>
                    ...
                    {!loading && countryData ? (
                        ...
                        >
                            ...
                            <div style={{ flex: '1 0 65%', textAlign: 'left' }}>
                                ...
                                <div className="para">
                                    {countryData.lockdownInfo.details}
                                </div>{' '}
                                <br />
