        ...
        <div>
            ...
            <div>
                {newsData.length === 0 ? (
                    ...
                    <span className="news-header">
                        Covid news for selected region
                    </span>
                ) : country === 'zz' ? (
                    <span className="news-header">
                        Covid news from everywhere
                    </span>
                ) : (
                    <span className="news-header">
                        Sorry, no recent news found for the selected region -
                        here is the top news for COVID-19 from around the world
                    </span>
                )}
                                    ...
                                    <Card
                                        ...
                                        cover={
                                            <Image
                                                ...
                                                src={item.urlToImage}
                                                placeholder={
                                                    <LoadingOutlined className="img-loader" />
                                                }
                                                preview={false}
                                                fallback="https://via.placeholder.com/300.jpg?text=No+Image"
                                            />
                                        }
                                    >
